...
with selection_tab:
    ...
    if "ranking" in st.session_state:
        ...
        heatmap_width = max(9, min(22, 0.8 * len(st.session_state.selected)))
        ...
        ax.set_xlabel("Selected CV feature")
        ...
        fig, ax = plt.subplots(figsize=(
            max(10, min(22, .8 * len(st.session_state.selected))),
            max(5, min(20, .38 * len(standardized_profile))),
        ))
        sns.heatmap(
            standardized_profile,
            cmap="coolwarm",
        ...
        ax.set(xlabel="Selected CV feature", ylabel="Experimental condition",
        ...
        ph_by_temperature = pd.DataFrame.from_dict(ph_correlation_rows, orient="index")
        if ph_by_temperature.empty:
            ...
            fig, ax = plt.subplots(figsize=(max(10, min(22, .8 * len(st.session_state.selected))),
                                             max(4, .55 * len(ph_by_temperature))))
            ...
            ax.set(xlabel="Selected CV feature", ylabel="Temperature",
        ...
        if temperature_by_ph.empty:
            ...
            ax.set(xlabel="Selected CV feature", ylabel="pH",
